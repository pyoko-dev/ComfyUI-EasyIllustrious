...
class IllustriousPony:
        ...
        PSONA_UI_PONY_TOKENS: Dict = {
            "optional": {
                "prefix": (
                    ...
                    {
                        "forceInput": True,
                        "tooltip": "Optional text to prepend before Pony tokens.",
                    },
                ),
                "suffix": (
                    "STRING",
                    {
                        "forceInput": True,
                        "tooltip": "Optional text to append after Pony tokens.",
                    },
                ),
            },
            "required": {
                "Quality": (
                    list(IllustriousPony.PonyTokens.__members__.keys()),
                    {
                        "default": "EVERYTHING",
                        "tooltip": "Quality token set (e.g., GOOD ≈ score_7_up).",
                    },
                ),
                "Source": (
                    ["-"] + IllustriousPony.SOURCES,
                    {
                        "default": "-",
                        "tooltip": "Optional source filter (adds tag if not '-').",
                    },
                ),
                "Rating": (
                    ["-"] + IllustriousPony.RATING,
                    {
                        "default": "-",
                        "tooltip": "Optional rating filter (adds tag if not '-').",
                    },
                ),
                "Invert Source (Neg)": (
                    "BOOLEAN",
                    {
                        "default": False,
                        "tooltip": "Push the source into the negative prompt instead.",
                    },
                ),
                "Invert Rating (Neg)": (
                    "BOOLEAN",
                    {
                        "default": False,
                        "tooltip": "Push the rating into the negative prompt instead.",
                    },
                ),
                "Pony Quality Boost (Beta)": (
                    ...
                    {
                        "default": False,
                        "tooltip": "Append a curated negative list to lift overall quality.",
                    },
                ),
                "Pony Negative Boost (Beta)": (
                    ...
                    {
                        "default": False,
                        "tooltip": "Append an expanded negative list targeting artifacts.",
                    },
                ),
            },
        }
    ...
    def display(self, **kwargs) -> tuple:
        ...
        quality_value = f"{IllustriousPony.PonyTokens[kwargs['Quality']].value}"
